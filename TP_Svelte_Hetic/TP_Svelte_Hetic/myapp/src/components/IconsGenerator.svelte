...
<div
  class="icon-wrapper"
  class:border
  style="border: {border ? `1px solid ${fillColor}` : 'none'}; padding: {url ? "0px" : "5px"}"
>
  ...
  {#if url}
    <figure
      class="icon-wrapper"
      style="background-image: url({url}); background-size: cover; height: {size}px; width: {size}px"
    />
  {/if}
</div>
